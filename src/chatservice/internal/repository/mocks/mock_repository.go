...
// Source: github.com/cshep4/premier-predictor-microservices/src/chatservice/internal/interfaces (interfaces: Repository)
...
func (m *MockRepository) SaveReadReceipt(arg0 model.ReadReceipt) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SaveReadReceipt", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// SaveReadReceipt indicates an expected call of SaveReadReceipt
func (mr *MockRepositoryMockRecorder) SaveReadReceipt(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SaveReadReceipt", reflect.TypeOf((*MockRepository)(nil).SaveReadReceipt), arg0)
}
