...
// Source: github.com/cshep4/premier-predictor-microservices/src/chatservice/internal/service (interfaces: Service)
...
func (m *MockService) SaveMessage(arg0 model.Message) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) SaveMessage(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMessage", reflect.TypeOf((*MockService)(nil).SaveMessage), arg0)
}
